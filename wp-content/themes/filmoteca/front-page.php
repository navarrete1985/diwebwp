                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content text-center">
                                <h6 data-animation="fadeInUp" data-delay="100ms">Estrenos</h6>
                                <h2 data-animation="fadeInUp" data-delay="300ms">En Cines <span>En Cines</span></h2>
                                <a data-animation="fadeInUp" data-delay="500ms" href="#" class="btn oneMusic-btn mt-50">Saber más <i class="fa fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single-hero-slide d-flex align-items-center justify-content-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content text-center">
                                <h6 data-animation="fadeInUp" data-delay="100ms">Últimas Reviews</h6>
                                <h2 data-animation="fadeInUp" data-delay="300ms">Críticas de Cine <span>Críticas de Cine</span></h2>
                                <a data-animation="fadeInUp" data-delay="500ms" href="#" class="btn oneMusic-btn mt-50">Saber más <i class="fa fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
